  ...
  return (
    <>
      <main className="pt-20">
        ...
        {/* FAQ Section */}
        <FAQ title={"Frequently Asked Questions About Development Services"}
          description={"Find answers to common questions about our development services offerings and how we can help your business leverage the power of the development."}
          faqs={webFAQs}
        />
        ...
        {/* <section className="w-full py-16 md:py-24 bg-white" id="contact">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-[#1e2942] mb-6">Start Your Web Project Today</h2>
              <p className="text-lg text-gray-600">
                Ready to transform your web presence? Contact us today to discuss your project and discover how our web
